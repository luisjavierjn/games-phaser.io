    ...
    var game = new Phaser.Game(672, 496, Phaser.AUTO);
    var palabras = ["ACTITUD", "APTITUD", "CONOCIMIENTO", "CANALES"];
  ...
  // write your prefab's specific update code here
    ...
    Lexer.prototype = {
        ...
        Check: function(evento, abc) {
            ...
            console.log("#1: " + this.Estado_Actual + " " + this.Key + " " + evento);
        },
        ...
        _concatenar: function() {
            ...
            var p = this.Buffer + this.Key;
            var n = palabras[this.Index].indexOf(p);
    ...
    BasicGame.Preloader.prototype = {
            ...
            preload: function () {
                    ...
                    //alert("478 level: " + level);
                    this.load.tilemap('map', 'assets/pacman-map'+level+'.json', null, Phaser.Tilemap.TILED_JSON);
                    //this.load.spritesheet('dude', 'assets/dude.png', 21, 31);
                    //  Needless to say, graphics (C)opyright Namco

                    this.load.image('A', 'assets/grandes/A.png');
                    this.load.image('B', 'assets/grandes/B.png');
                    this.load.image('C', 'assets/grandes/C.png');
                    this.load.image('D', 'assets/grandes/D.png');
                    this.load.image('E', 'assets/grandes/E.png');
                    this.load.image('F', 'assets/grandes/F.png');
                    this.load.image('G', 'assets/grandes/G.png');
                    this.load.image('H', 'assets/grandes/H.png');
                    this.load.image('I', 'assets/grandes/I.png');
                    this.load.image('J', 'assets/grandes/J.png');
                    this.load.image('K', 'assets/grandes/K.png');
                    this.load.image('L', 'assets/grandes/L.png');
                    this.load.image('M', 'assets/grandes/M.png');
                    this.load.image('N', 'assets/grandes/N.png');
                    this.load.image('Ñ', 'assets/grandes/Ñ.png');
                    this.load.image('O', 'assets/grandes/O.png');
                    this.load.image('P', 'assets/grandes/P.png');
                    this.load.image('Q', 'assets/grandes/Q.png');
                    this.load.image('R', 'assets/grandes/R.png');
                    this.load.image('S', 'assets/grandes/S.png');
                    this.load.image('T', 'assets/grandes/T.png');
                    this.load.image('U', 'assets/grandes/U.png');
                    this.load.image('V', 'assets/grandes/V.png');
                    this.load.image('W', 'assets/grandes/W.png');
                    this.load.image('X', 'assets/grandes/X.png');
                    this.load.image('Y', 'assets/grandes/Y.png');
                    this.load.image('Z', 'assets/grandes/Z.png');
    ...
    BasicGame.Pacman.prototype = {
        ...
        preload: function () {
            ...
            */
            //alert("651 level: " + level);
            //this.scale.setGameSize(window.innerWidth, window.innerHeight);
            
            this.analyzer = new Lexer(palabras); 
            this.analyzer.Init(level);
            this.nletters = this.analyzer.ValidLetters;  
        ...
        create: function () {
            ...
            */
            ...
            this.livesText = this.add.text((17 * 16), (2 * 16) + 8, 'Tu Puedes', { fontSize: '24px', fill: '#fff' });
            ...
            this.oracion1 = this.add.text((29 * 16), (5 * 16) + 8, '1) La ___________ es la respuesta\n o reacción que se realiza frente a\n las situaciones o personas la cual\n  se ejecuta en forma mecánica.', { fontSize: '12px', fill: '#fff' });
            this.oracion2 = this.add.text((29 * 16), (11 * 16) + 8, '2) La ___________ se refiere a las\n capacidades y disposición de una\n persona para desempeñarse o\n ejercer determinada tarea.', { fontSize: '12px', fill: '#000' });
            this.oracion3 = this.add.text((29 * 16), (17 * 16) + 8, '3) La comprensión de todas las\n acciones relacionadas con la\n prestación de servicio, se refiere\n al ___________.', { fontSize: '12px', fill: '#000' });
            this.oracion4 = this.add.text((29 * 16), (23 * 16) + 8, '4) Los puntos de contacto con el\n cliente;  espacios físicos,\n virtuales o Contact Center, se\n conoce como ___________.', { fontSize: '12px', fill: '#000' });

            switch(level){
                case 3:      
                    this.oracion3.text = '3) La comprensión de todas las\n acciones relacionadas con la\n prestación de servicio, se refiere\n al CONOCIMIENTO.';
                    this.oracion4.fill = '#fff';
                case 2:
                    this.oracion2.text = '2) La APTITUD se refiere a las\n capacidades y disposición de una\n persona para desempeñarse o\n ejercer determinada tarea.';
                    this.oracion3.fill = '#fff';
                case 1:              
                    this.oracion1.text = '1) La ACTITUD es la respuesta\n o reacción que se realiza frente a\n las situaciones o personas la cual\n  se ejecuta en forma mecánica.';
                    this.oracion2.fill = '#fff';
                    break;
            }            
        },
        ...
        getKill: function (pacman, player) {
            ...
            pacman.kill();
            //this.lives--; //- aquí se reducen las vidas
        ...
        eatAbc: function (pacman, abc) {
            ...
            if(n <= 10) 
            {
                ...
                {                        
                    ...
                    //console.log("abc : " + abc.key);                    
                    
                    if(this.analyzer.ValidLetters > this.nletters)
                    {
                        abc.kill();
                        this.nletters = this.analyzer.ValidLetters;
                        /*
                        ...
                        //this.selection[this.idxsel].kill();
                        //this.safetiles[this.idxsel].visible = true;
        ...
        update: function () {
            ...
            */
            if(this.analyzer.detected === (level+1)){
                level++;
                ...
                if(level === 4) {
                    ...
                    //----
                    this.oracion4.text = '4) Los puntos de contacto con el\n cliente;  espacios físicos,\n virtuales o Contact Center, se\n conoce como CANALES.';
